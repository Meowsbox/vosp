...
import com.meowsbox.vosp.android.common.util.AsyncTaskExecutor;
import com.meowsbox.vosp.android.common.util.AsyncTaskExecutors;
import com.meowsbox.vosp.android.common.util.PhoneNumberUtil;
import com.meowsbox.vosp.android.common.util.TelecomUtil;
...
//                    .appendQueryParameter(CallLog.Calls.LIMIT_PARAM_KEY, Integer.toString(1000))
//                    .build();
            Log.v("callUri",callUri.toString());
            cursor = context.getContentResolver().query(callUri, CallDetailQuery.CALL_LOG_PROJECTION, null,null,null);
        } catch (Exception e) {
            // failed to get permission or some other error
            e.printStackTrace();
        }
