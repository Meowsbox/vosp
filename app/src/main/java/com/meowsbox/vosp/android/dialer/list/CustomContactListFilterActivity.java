...
import com.meowsbox.vosp.android.common.model.AccountTypeManager;
import com.meowsbox.vosp.android.common.model.ValuesDelta;
...
import com.meowsbox.vosp.android.common.util.EmptyService;
import com.meowsbox.vosp.android.common.util.LocalizedNameResolver;
import com.meowsbox.vosp.android.common.util.WeakAsyncTask;
        ...
        public AccountSet loadInBackground() {
            ...
            for (AccountWithDataSet account : accountTypes.getAccounts(false)) {
                ...
                android.content.EntityIterator iterator =
                        Groups.newEntityIterator(resolver.query(
