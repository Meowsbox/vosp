...
public abstract class PhoneFavoriteTileView extends ContactTileView {
        ...
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(mPhoneNumberString)) {
                    ...
                    mListener.onContactSelected(getLookupUri(), MoreContactUtils.getTargetRectFromView(PhoneFavoriteTileView.this));
                } else {
    ...
    protected DefaultImageRequest getDefaultImageRequest(String displayName, String lookupKey) {
        return new DefaultImageRequest(displayName, lookupKey, ContactPhotoManager.TYPE_DEFAULT, DEFAULT_IMAGE_LETTER_SCALE, DEFAULT_IMAGE_LETTER_OFFSET, false);
    }
