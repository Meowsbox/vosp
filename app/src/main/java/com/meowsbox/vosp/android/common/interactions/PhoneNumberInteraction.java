 ...
 */
package com.meowsbox.vosp.android.common.interactions;
...
import com.meowsbox.vosp.android.common.Collapser;
import com.meowsbox.vosp.android.common.MoreContactUtils;
import com.meowsbox.vosp.android.common.database.ContactUpdateUtils;
import com.meowsbox.vosp.android.common.util.ContactDisplayUtils;
...
public class PhoneNumberInteraction implements OnLoadCompleteListener<Cursor> {
     ...
     */
    @VisibleForTesting
    /* package */ static class PhoneItem implements Parcelable, Collapser.Collapsible<PhoneItem> {
        long id;
        String phoneNumber;
        String accountType;
        String dataSet;
...
//                    activity.startService(serviceIntent);
                    // fix for non system app contact update
                    ContactUpdateUtils.setSuperPrimary(getActivity(),phoneItem.id);
                }
