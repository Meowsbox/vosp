...
import com.meowsbox.vosp.android.dialer.list.ViewPagerTabs;
...
public class CallLogActivity extends Activity implements CallLogQueryHandler.Listener {
    ...
    private int primary_color = Prefs.DEFAULT_UI_COLOR_PRIMARY;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            } else if (callType == Calls.VOICEMAIL_TYPE) {
                startingTab = TAB_INDEX_VOICEMAIL;
            }
            primary_color = intent.getIntExtra(Prefs.KEY_UI_COLOR_PRIMARY, Prefs.DEFAULT_UI_COLOR_PRIMARY);
        }
    ...
    private void setColors() {
        getActionBar().setBackgroundDrawable(new ColorDrawable(primary_color));
        mViewPagerTabs.setColorPrimary(primary_color);
    }
