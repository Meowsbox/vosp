...
import com.meowsbox.vosp.FragmentMessages;
import com.meowsbox.vosp.R;
import com.meowsbox.vosp.android.common.GeoUtil;
import com.meowsbox.vosp.android.common.util.DialerUtils;
import com.meowsbox.vosp.android.dialer.ObjectFactory;
import com.meowsbox.vosp.android.dialer.callog.CallLogAdapter;
import com.meowsbox.vosp.android.dialer.callog.CallLogFragment;
import com.meowsbox.vosp.android.dialer.callog.CallLogQuery;
import com.meowsbox.vosp.android.dialer.callog.CallLogQueryHandler;
import com.meowsbox.vosp.android.dialer.callog.ContactInfoHelper;
import com.meowsbox.vosp.android.dialer.list.ShortcutCardsAdapter.SwipeableShortcutCard;
import com.meowsbox.vosp.android.dialer.widget.OverlappingPaneLayout;
import com.meowsbox.vosp.android.dialer.widget.OverlappingPaneLayout.PanelSlideCallbacks;
...
public class ListsFragment extends Fragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCallLogAdapter = ObjectFactory.newCallLogAdapter(getActivity(), this, new ContactInfoHelper(getActivity(), currentCountryIso), null, null, false);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        flMessages = parentView.findViewById(R.id.flMessages);

        getFragmentManager().beginTransaction()
                .add(R.id.flMessages, fragmentMessages = new FragmentMessages())
                .commit();
...
//            mSpeedDialFragment.sendScreenView(); // analytics
        } else if (position == TAB_INDEX_RECENTS && mRecentsFragment != null) {
//            mRecentsFragment.sendScreenView(); // analytics
        } else if (position == TAB_INDEX_ALL_CONTACTS && mAllContactsFragment != null) {
//            mAllContactsFragment.sendScreenView(); // analytics
        }
        final int count = mOnPageChangeListeners.size();
        for (int i = 0; i < count; i++) {
    ...
    public void showRemoveView(boolean show) {
        flMessages.setVisibility(!show ? View.VISIBLE : View.GONE); // hide extra view so not to interfere with remove view
    ...
    public void setColorPrimary(int color) {
        mViewPagerTabs.setColorPrimary(color);
        mShortcutCardsListView.setBackgroundColor(color);
        flMessages.setBackgroundColor(color);
        fragmentMessages.setPrimaryColor(color);
    }
}
